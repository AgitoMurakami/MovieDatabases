...
public class ConnectInternetTrailer extends AsyncTask<URL, Integer, Trailer> {
    ...
    protected Trailer doInBackground(URL... urls) {
        ...
        Trailer tmpModel = tmpGSON.fromJson(tmpResult, Trailer.class);

        return tmpModel;
    }

    @Override
    protected void onPostExecute(Trailer s) {
